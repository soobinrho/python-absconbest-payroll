...
Use and extend our package freely please. To develop *Python* functions, look at the files in our repository. For us, many files are meaningless, auto-generated by *setuptools* which builds *Python* source codes for distribution. So, ignore all the files other than:
