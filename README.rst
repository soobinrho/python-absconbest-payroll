...
The *Python* function generates a graph, using `Plotly <https://github.com/plotly/plotly.py>`_, and report, using *`PyLatex <https://github.com/JelteF/PyLaTeX>`*. In *Ubuntu*, open a terminal and type the following command:
